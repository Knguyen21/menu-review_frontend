...
/***/ function(module, exports, __webpack_require__) {
	...
	var getRestaurantsApi = __webpack_require__(3);
	var userApi = __webpack_require__(29);
	__webpack_require__(31);
	var createReview = __webpack_require__(32);
	var deleteReview = __webpack_require__(33);
	var updateReview = __webpack_require__(34);

	// display homepage when clicking home button on the top
	var homepageDisplay = function homepageDisplay() {
	...
	var deleteReviewForm = function deleteReviewForm() {
	...
	var updateReviewForm = function updateReviewForm() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayRestaurants = function displayRestaurants(response) {
	  var restaurants = response.restaurants;
	  var restaurantListingTemplate = __webpack_require__(27);
	  $('.restaurant-listing').html(restaurantListingTemplate({ restaurants: restaurants }));
	};

	// get all the meals data from a certain restaurant that you clicked
	var displayRestaurantMeals = function displayRestaurantMeals(restaurantID) {
	...
	var displayMenuTitle = function displayMenuTitle(response) {
	  var restaurant = response.restaurant;
	  var menuTitleTemplate = __webpack_require__(28);
	  $('#menu-title').html(menuTitleTemplate({ restaurant: restaurant }));
	};

	// send an ajax get request for a specific restaurant data
	var getSpecificRestaurants = function getSpecificRestaurants(restaurantID) {
	  $.ajax({
	...
	var getMealsMenu = function getMealsMenu() {
	...
	module.exports = {
	  ...
	  displayRestaurantMeals: displayRestaurantMeals,
	  getMealsMenu: getMealsMenu,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayMeals = function displayMeals(response, meal_type) {
	  var meals = response.meals;
	  var mealListingTemplate = __webpack_require__(26);
	  $(meal_type).html(mealListingTemplate({ meals: meals }));
	  writeReview();
	...
	var getMeals = function getMeals(restaurantID, urlMealType, mealType) {
	  $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateMealReview = function updateMealReview() {
	...
	var deleteMealReview = function deleteMealReview() {
	...
	var displayReviews = function displayReviews(response, review) {
	  var reviews = response.reviews;
	  var reviewListingTemplate = __webpack_require__(6);
	  $(review).html(reviewListingTemplate({ reviews: reviews }));
	  deleteMealReview();
	  updateMealReview();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<br>"
	    + alias1(container.lambda(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.email : stack1), depth0))
	    + "\n<br>comment: "
	    + alias1(((helper = (helper = helpers.comment || (depth0 != null ? depth0.comment : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"comment","hash":{},"data":data}) : helper)))
	    + "\n<br>rating: "
	    + alias1(((helper = (helper = helpers.rating || (depth0 != null ? depth0.rating : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"rating","hash":{},"data":data}) : helper)))
	    + "\n<br>\n<button type=\"button\" class=\"btn btn-primary btn-sm update-review\" data-review-id=\""
	    ...
	    + "\">update</button>\n<button type=\"button\" class=\"btn btn-primary btn-sm delete-review\" data-review-id=\""
	    + alias1(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">delete</button>\n<br>\n<br>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div data-meal-id="
	    ...
	    + "\n    <br>\n    <button type=\"button\" class=\"btn btn-primary btn-sm reviews-button\" data-toggle=\"modal\" data-target=\"#reviews\" >\n    Reviews</button>\n    <button type=\"button\" class=\"btn btn-primary btn-sm write-review\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n    Write Review</button>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
	  ...
	  return "\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.meals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li><a class=\"restaurant-link\" data-restaurant-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" > "
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.restaurants : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n    <h1>"
	    ...
	    + "</h1>\n    <h4>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.address : stack1), depth0))
	    + "</h4>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayUser = function displayUser(response) {
	  var user = response.user;
	  var userTemplate = __webpack_require__(30);
	  $('#user-email').html(userTemplate({ user: user }));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createReview = function createReview(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteReview = function deleteReview(e) {
	  e.preventDefault();
